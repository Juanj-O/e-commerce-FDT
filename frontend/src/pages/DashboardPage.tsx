              ...
              <div className="mb-6 -mx-5 px-5 overflow-x-auto scrollbar-hide">
                <div className="flex gap-2 min-w-max pb-2">
                  {CATEGORIES.map((category) => (
                    <button
                      key={category}
                      className="px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap bg-gray-50 text-gray-600 hover:bg-gray-100 border border-gray-200"
                    >
                      {category}
                    </button>
                  ))}
