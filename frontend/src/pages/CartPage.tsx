...
const CartPage = () => {
  ...
  const estimatedShipping = 83630; // Valor estimado de envío
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-4 md:px-6 py-4 md:py-8 w-full">
        ...
        <div className="bg-white rounded-lg p-3 md:p-4 mb-3 md:mb-4 flex items-center gap-2 text-xs md:text-sm">
          ...
          <span className="px-2 py-0.5 md:py-1 bg-gray-100 text-gray-700 text-[10px] md:text-xs rounded">
            Empresa de envío
          </span>
        </div>
              ...
              <div className="flex gap-3 md:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-2 gap-2">
                    <h3 className="text-sm md:text-sm font-medium text-gray-900 flex-1">
                      {item.product.name}
                    </h3>
                    <button
                  ...
                  <div className="flex flex-wrap gap-1.5 md:gap-2 mb-3">
                    <span className="px-1.5 md:px-2 py-0.5 md:py-1 bg-teal-100 text-teal-700 text-[10px] md:text-xs font-medium rounded">
                      EXCLUSIVO
                    </span>
                    <span className="px-1.5 md:px-2 py-0.5 md:py-1 bg-purple-100 text-purple-700 text-[10px] md:text-xs font-medium rounded">
                      PREVENTA
                    </span>
                  </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 md:p-6">
            ...
            <div className="pt-2 md:pt-3 border-t border-gray-200">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg md:text-xl font-bold text-gray-900">
                  {formatPrice(total + estimatedShipping)}
                </span>
              </div>
            </div>
          </div>
          ...
          >
            Comprar {cartItems.length} producto{cartItems.length > 1 ? 's' : ''}
          </button>
          ...
          <div className="mt-3 md:mt-4 flex items-start gap-2 text-[10px] md:text-xs text-gray-500">
            ...
            <span className="leading-tight">
              Los productos del carrito se eliminarán después de 90 días.
            </span>
          </div>
        </div>
      </div>
